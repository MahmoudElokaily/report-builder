...
<div class="container">
    ...
    <div class="show">
        <div class="contact-form">
            <form action="{{route('report-pie-chart')}}" method="post" class="fixed">
                @csrf
                ...
                <button class="btn" type="submit">Pie Chart</button>
            </form>
        </div>
    </div>
</div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(i,item){
                    $(".list").append(` <li style="background: white"><input type="radio" name="field" value="${item.Field}"> ${item.Field}</li> <br> `).trigger('change');
                }) ;
